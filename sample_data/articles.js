const articles = [
  ...
  },
  {
    ...
    authors: [
      ...
      {
        name: "Gian Kristian A. Fontanilla",
        affiliations: ["DLSU"],
      },
      {
        name: "Anne  Marie M. Africa",
        affiliations: ["DLSU"],
      },
      {
        name: "Karmela Angela G. Cortez",
        affiliations: ["DLSU"],
      },
      {
        name: "Paul Michael O. Go",
        affiliations: ["DLSU"],
      },
    ],
  ...
  },
  {
    ...
    authors: [
      ...
      {
        name: "Jolene Valenzuela",
        affiliations: ["DLSU"],
      },
      {
        name: "Jose Ma. Santiago III",
        affiliations: ["DLSU"],
      },
      {
        name: "Jordan Aiko Deja",
  ...
  },
  {
    ...
    authors: [
      {
        name: "Arvin Christopher C. Reyes",
        affiliations: ["DLSU"],
      },
      {
        name: "Neil Patrick A. Del Gallego",
        affiliations: ["DLSU"],
      },
      {
        name: "Jordan Aiko Deja",
  ...
  },
  {
    ...
    authors: [
      ...
      {
        name: "John Patrick Tobias",
        affiliations: ["DLSU"],
      },
      {
        name: "Allen Vincent Gonzales",
        affiliations: ["DLSU"],
      },
      {
        name: "Migo Andres Dancel",
        affiliations: ["DLSU"],
      },
    ],
    topics: ["Artificial Intelligence", "Robotics"],
  ...
  },
  {
    ...
    authors: [
      {
        name: "Juan Miguel Augusto M. Feria",
        affiliations: ["DLSU"],
      },
      {
        name: "Michael Lawrence S. Oliva",
        affiliations: ["DLSU"],
      },
      {
  ...
  },
  {
    ...
    authors: [
      ...
      {
        name: "Kyle L. Santiago",
        affiliations: ["DLSU"],
      },
      {
        name: "Ian Benedict M. Ona",
        affiliations: ["DLSU"],
      },
      {
        name: "Romeo Manuel N. Peña",
        affiliations: ["DLSU"],
      },
      {
        name: "Geremiah Zachary S. Marasigan",
        affiliations: ["DLSU"],
      },
      {
        name: "Paolo Gabriel A. Delos Reyes",
        affiliations: ["DLSU"],
      },
      {
        name: "Briane Paul V. Samson",
  ...
  },
  {
    ...
    authors: [
      ...
      {
        name: "Alexczar Dela Torre",
        affiliations: ["DLSU"],
      },
      {
        name: "Hans Joshua Lee",
        affiliations: ["DLSU"],
      },
      {
        name: "Jose Florencio Ciriaco IV",
        affiliations: ["DLSU"],
      },
      {
        name: "Carlo Miguel Eroles",
        affiliations: ["DLSU"],
      },
    ],
    topics: ["Artificial Intelligence", "Robotics"],
